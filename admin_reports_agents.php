...
<head>
  ...
  <title>Manage Reports (Associate Agent) | BatEstateExplorer</title>
...
<body>
  <div class="dashboard-container">
    ...
    <main class="main-content">
      ...
      <div class="report-list" id="realEstateAgentsReports">
        <div class="no-reports">No agent reports available</div>
      </div>
    </main>
  </div>
  <script>
    ...
    const realEstateAgentsReports = document.getElementById('realEstateAgentsReports');
    function sortReports(criteria) {
      const cards = Array.from(realEstateAgentsReports.querySelectorAll('.report-card'));
      if (cards.length > 0) {
        let sorted;
        if (criteria === 'name') {
        ...
        sorted.forEach(card => realEstateAgentsReports.appendChild(card));
      }
    }
