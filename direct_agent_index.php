...
<head>
  ...
  <title>BatEstateExplorer | Direct Agent Homepage</title>
...
<body>
  ...
  <div class="header-content">
    ...
    <nav>
      <ul>
        ...
        <li><a href="direct_agent_search.php" class="btn rounded-btn" style="background: #000000; color: #fff;"><i class="fa-solid fa-house"></i> Properties</a></li> 

        <li><a href="direct_agent_dashboard_full.php" class="btn rounded-btn" style="background: #000000; color: #fff;"><i class="fa-solid fa-user"></i> Dashboard</a></li>
        <!-- Removed Become a Direct Agent button for direct agent homepage -->
      </ul>
    </nav>
  </div>
</header>
  ...
  <section id="hero">
    <div class="hero-container">
      <h2 class="hero-title">Welcome, Direct Agent!</h2>
      <p class="hero-subtitle">Manage your listings and connect with buyers in Batangas.</p>
      <!-- Search Box -->
  ...
  <script>
    document.getElementById('searchBtn').addEventListener('click', () => {
      ...
      // Redirect to direct_agent_search.html with filters
      const searchUrl = `direct_agent_search.php?${queryParams.toString()}`;
          ...
          for (let i = sliderIndex; i < Math.min(sliderIndex + 4, sliderData.length); i++) {
            ...
            card.innerHTML = `
              <div class="property-image">
                ...
                <img src="${p.image || 'Pictures/bg4.jpg'}" alt="${p.title}" style="width:100%;height:100px;object-fit:cover;border-radius:12px 12px 30px 30px;">
              </div>
