...
<head>
  ...
  <title>Manage Direct Agents | BatEstateExplorer</title>
...
<body>
        ...
        <ul>
          ...
          <li class="nav-dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="admin_direct_agents.php" class="active">Direct Agents</a></li>
      ...
      <div class="direct-agent-list" id="agentList">
        ...
        <?php else: ?>
          <?php foreach ($direct_agents as $agent): ?>
            <div class="direct-agent-card" data-name="<?php echo htmlspecialchars($agent['first_name'] . ' ' . $agent['last_name']); ?>" data-date="<?php echo $agent['created_at']; ?>" data-experience="<?php echo $agent['experience_years'] ?? 0; ?>">
  ...
  <script>
            ...
            modalBody.innerHTML = `
              ...
              <div class="detail-section">
                ...
                <div class="detail-row">
                  ...
                  <div class="detail-value">${(agent.user_type || 'direct_agent').replace('_', ' ').toUpperCase()}</div>
                </div>
                <div class="detail-row">
    ...
    document.getElementById('sort').addEventListener('change', function() {
      ...
      const cards = Array.from(document.querySelectorAll('.direct-agent-card'));
