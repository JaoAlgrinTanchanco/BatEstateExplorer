...
// 🔹 If coming from a property, fetch agent_id (agents.id) via API
if ($property_id) {
...
// 🔹 Convert agent_id (agents.id) to user_id
$user_id = null;
if ($agent_id) {
...
// Now $agent contains the agent user info for messaging
// and $agents_list contains all available agents
?>
<!DOCTYPE html>
<html lang="en">
<head>
