...
$stats['total_properties'] = mysqli_fetch_assoc($result)['count'];

// Available properties
$query = "SELECT COUNT(*) as count FROM properties WHERE status = 'available'";
$result = mysqli_query($conn, $query);
$stats['available_properties'] = mysqli_fetch_assoc($result)['count'];

// Sold properties
$query = "SELECT COUNT(*) as count FROM properties WHERE status = 'sold'";
$result = mysqli_query($conn, $query);
$stats['sold_properties'] = mysqli_fetch_assoc($result)['count'];

// Total agents
$query = "SELECT COUNT(*) as count FROM users WHERE user_type IN ('direct_agent', 'associate_agent')";
$result = mysqli_query($conn, $query);
...
<head>
  ...
  <title>Manage Reports | BatEstateExplorer</title>
  ...
  <div class="dashboard-container">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <ul>
          ...
          <li><a href="#" class="active"><i class="fa-solid fa-flag"></i> Reports</a></li>
    ...
    <main class="main-content">
      ...
      <div class="tab-bar">
        ...
        <a href="admin_reports_clients.php" class="tab">Clients</a>
      </div>
      <div class="report-list" id="propertyOwnersReports">
        <div class="no-reports">No reports available</div>
      </div>
    </main>
  </div>
  <script>
    ...
    const allReportLists = [
      document.getElementById('propertyOwnersReports'),
      document.getElementById('realEstateAgentsReports'),
      document.getElementById('clientReports')
    ];
    function sortReports(criteria) {
      allReportLists.forEach(list => {
        if (list) {
