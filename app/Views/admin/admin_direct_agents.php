...
<head>
    ...
    <title>Direct Agents | BatEstate</title>
    ...
    <div class="admin-container">
        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="admin_dashboard.php?view=direct_agents" class="active"><i class="fa-solid fa-user-tie"></i> Direct Agents</a></li>
        ...
        <div class="main-content">
            <header class="content-header">
                <h1>Direct Agents Management</h1>
                <div class="user-info">
            ...
            <div class="content-body">
                <h2>Direct Agents</h2>
                <p>This page will contain the direct agents management functionality.</p>
                <p>Coming soon...</p>
            </div>
        </div>
    </div>
