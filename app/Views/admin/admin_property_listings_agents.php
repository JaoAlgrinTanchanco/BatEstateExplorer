...
<head>
    ...
    <title>Admin Property Listings Agents | BatEstate</title>
    ...
    <div class='admin-container'>
        ...
        <div class='main-content'>
            <header class='content-header'>
                <h1>Admin Property Listings Agents</h1>
                <div class='user-info'>
            ...
            <div class='content-body'>
                <h2>Admin Property Listings Agents</h2>
                <p>This page will contain the admin property listings agents functionality.</p>
                <p>Coming soon...</p>
            </div>
        </div>
    </div>
