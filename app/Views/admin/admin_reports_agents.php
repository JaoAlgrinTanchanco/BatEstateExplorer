...
<head>
    ...
    <title>Admin Reports Agents | BatEstate</title>
    ...
    <div class='admin-container'>
        ...
        <div class='main-content'>
            ...
            <div class='content-body'>
                <h2>Admin Reports Agents</h2>
                <p>This page will contain the admin reports agents functionality.</p>
                <p>Coming soon...</p>
            </div>
        </div>
    </div>
