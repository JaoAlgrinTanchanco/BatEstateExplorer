...
<head>
    ...
    <title>Associate Agents | BatEstate</title>
    ...
    <div class="admin-container">
        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="admin_dashboard.php?view=associate_agents" class="active"><i class="fa-solid fa-users"></i> Associate Agents</a></li>
        ...
        <div class="main-content">
            <header class="content-header">
                <h1>Associate Agents Management</h1>
                <div class="user-info">
            ...
            <div class="content-body">
                ...
                <p>This page will contain the associate agents management functionality.</p>
                <p>Coming soon...</p>
            </div>
        </div>
    </div>
